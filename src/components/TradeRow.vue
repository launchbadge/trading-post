        ...
        return () => (
            <div class="TradeRow">
                ...
                <div class="TradeRow-goldSwap">
                    {props.trade.requestorGold.toFormat() !== "0" ? <GoldAmount amount={ props.trade.requestorGold.toFormat() } /> : null}
                    <Icon class="TradeRow-swapIcon" d={ mdiSwapHorizontalVariant } />
                    {props.trade.requesteeGold.toFormat() !== "0" ? <div class="TradeRow-rightGold">
